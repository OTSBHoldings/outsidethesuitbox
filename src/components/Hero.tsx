...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto relative z-20 flex flex-col min-h-[calc(120vh-120px)] pt-20 md:pt-10">
        <div className="flex flex-col items-center justify-center h-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 text-center">
          <div className="w-full max-w-4xl mt-20">
            ...
            <div 
              ref={buttonRef}
              className="flex flex-col sm:flex-row justify-center gap-6 mt-20 mb-32 opacity-0 translate-y-10 transition-all duration-1000 ease-out delay-500"
            >
      ...
      {/* Position gold line significantly lower to avoid any overlap with buttons */}
      <div className="absolute bottom-24 left-0 right-0 h-px bg-gold/30 z-20"></div>
      
      {/* Scroll indicator positioned even lower below the gold line */}
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 z-20 flex flex-col items-center opacity-75 hover:opacity-100 transition-opacity">
